      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        >
          <h2 className="text-5xl sm:text-6xl font-medium mb-4 tracking-tight text-black">
            We help you connect,<br />stay informed, and apply
          </h2>
          <p className="text-base text-gray-500 font-light max-w-3xl mx-auto leading-relaxed">
            No more searching for jobs. No more guessing who to reach out to. No more missing out on applications
          </p>
        </motion.div>
