import { GraduationCap, Building2, Check, Mail } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
          ...
          >
            ...
            <button className="px-6 py-3 bg-black text-white rounded-full hover:bg-gray-700 transition-all hover:scale-105 active:scale-95 text-sm">
              Get Started
            </button>
          </motion.div>

          {/* Businesses / Enterprises / Agencies */}
          <motion.div
            initial={{ opacity: 0, x: 20 }}
            whileInView={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.6 }}
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-2xl font-medium text-white">Businesses / Enterprises / Agencies</h3>
            </div>
            ...
            <a 
              ...
              className="inline-flex items-center gap-2 px-6 py-3 bg-white text-black rounded-full hover:bg-gray-200 transition-all hover:scale-105 active:scale-95 text-sm"
            >
