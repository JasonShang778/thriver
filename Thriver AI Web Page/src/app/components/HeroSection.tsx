    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="relative max-w-6xl mx-auto px-6 lg:px-12 py-24 text-center">
        ...
        >
          <form onSubmit={handleSubmit} className="max-w-lg mx-auto">
            <div className="flex gap-2 p-1 bg-white border border-gray-200 rounded-full shadow-sm hover:shadow-md transition-shadow">
              ...
              <button 
                type="submit"
                className="px-6 py-3 bg-black text-white rounded-full hover:bg-gray-700 transition-all hover:scale-105 active:scale-95 whitespace-nowrap flex items-center gap-2"
              >
        ...
        >
          ...
          <button className="px-8 py-4 bg-white text-black border border-gray-300 rounded-full hover:border-gray-400 hover:bg-gray-50 transition-all hover:scale-105 active:scale-95 text-base inline-flex items-center justify-center gap-2">
